...
public class BadPairs {
    public static ArrayList<Integer> removeBadPairs (ArrayList<Integer> list){
        ...
        for (int i = 0; i < list.size(); i+= 2){
            ...
            if (list.get(i) < list.get(i + 1)){ // first pairs is good (if first number few then second)
...
return goodPairs;
    ...
    public static void main(String[] args) {
        ArrayList<Integer> num = new ArrayList<>(Arrays.asList(3, 4, 6, 1, 1, 10, 8, 7));
        System.out.println(removeBadPairs(num));
    }
