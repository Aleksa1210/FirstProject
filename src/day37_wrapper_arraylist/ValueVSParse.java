...
public class ValueVSParse {
    public static void main(String[] args) {
        ...
        String s = "30";
        int second = Integer.parseInt(s);// convert "30" String into an int of 30, MOST will use

        Integer i = Integer.valueOf(s); // convert the "30" String into the Integer wrapper class object
/*
        int i2 = Integer.valueOf(s); // better don't do such, conberts the "30" String into the Integer object
...
*/
        String s2 = String.valueOf(30); // convert "30" int to a String
