...
public class Library {
    public static void main(String[] args) {
        ...
        //Author author = new Author(); // here you making an Author object in the main method, it is local to the main method

        // but on line 30 the object is made with reference coming from the book object. The Author object belongs to the Book object
