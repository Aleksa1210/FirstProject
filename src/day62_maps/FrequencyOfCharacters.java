...
// counter is map = empty right now + try to put char
        if(counter.containsKey(key)){ // if mao container b
...
// counter.get(key) + 1 check if he had before a then make +1 -> a=2 -> a = 3
