...
public class Garage {
    public static void main(String[] args) {
      ...
      //  ElectricCar obj4 = new ElectricCar();
        // ElectricCar is abstract , we cannot create an object of this class
        ...
        // Tesla is not abstract class, so it was concrete, which it had to override all the abstract methods from the super classes
