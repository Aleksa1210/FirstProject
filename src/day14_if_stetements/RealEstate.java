...
public class RealEstate {
    public static void main(String[] args) {
        ...
        if (budget > 0 && budget < 300_000) {
            ...
            System.out.println("Lets see if there is houses");
            ...
            if (budget <= 0) {
                ...
                ad += "Gated: " + (gated ? "Yes" : "No"); // this means if the gated boolean is true it wil concatenate "yes", but if the gated is false it will concatenate "no" inti ad;
                ad += (allowPets ? "They allow pets" : "They don't allow pets");
                System.out.println();
