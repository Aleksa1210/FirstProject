...
public class ConverArrayToList {
    public static void main(String[] args) {
        ...
        Integer [] arr = {1, 2, 3}; // we made an Integer array because ArrayList doesn't accept primitive type
        //Object ArrayList + Array = collection type
    ...
    .asList method converts array to Arraylist
     */
