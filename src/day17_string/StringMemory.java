...
public class StringMemory {
    public static void main(String[] args) {
        ...
        String fourth = "Java"; //at this line, how much object in the String pool: 2// you have "java" "Java"
        System.out.println(first == fourth);



        // at this point how many total object ia there. 3 -> 2 in the String pool and 1 separate object directly in the heap
